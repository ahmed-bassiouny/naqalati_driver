...
public class MapActivity extends AppCompatActivity implements
                    ...
                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if(task.isSuccessful()){
                                SharedPref.setUpdatedToken(MapActivity.this);
                            }
                        }
                    });
        }
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if (!driver.getCurrentRequest().isEmpty()) {
                            ...
                            Toast.makeText(MapActivity.this, R.string.waiting, Toast.LENGTH_SHORT).show();
    ...
    private void onClick() {
        ...
        tvRequestCount.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MapActivity.this, ShowRequestsActivity.class));
            }
        });
        ...
        currentRequestListener = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (requestInfo.getRequestStatus() == RequestStatus.DRIVER_GO_TO_START_POINT) {
                    ...
                    Toast.makeText(MapActivity.this, R.string.driver_cancel, Toast.LENGTH_SHORT).show();
                    googleMap.clear();
                    ...
                    Toast.makeText(MapActivity.this, R.string.user_cancel, Toast.LENGTH_SHORT).show();
                    googleMap.clear();
                    container.setVisibility(View.GONE);
                    progress.setVisibility(View.GONE);
                    rateUser(currentRequest);
                    ...
                    Toast.makeText(MapActivity.this, R.string.complete, Toast.LENGTH_SHORT).show();
                    googleMap.clear();
                    container.setVisibility(View.GONE);
                    progress.setVisibility(View.GONE);
                    rateUser(currentRequest);
